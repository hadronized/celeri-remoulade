...
simple_animation!(animation_chromatic_aberration, f32, 1., [
  ...
  (49.5, 1., Interpolation::Hold),
  (59.24, 50., Interpolation::Cosine),
  (59.44, 100., Interpolation::Cosine),
  (60.04, 80., Interpolation::Cosine),
...
simple_animation!(animation_jitter, f32, 0., [
  ...
  (59.05, 1., Interpolation::Linear),
  (59.2, 0.5, Interpolation::Linear),
  (59.35, 1., Interpolation::Linear),
  (59.5, 0.5, Interpolation::Linear),
  (59.65, 1., Interpolation::Linear),
  (59.8, 0.5, Interpolation::Linear),
  (59.95, 1., Interpolation::Linear),
  (60.1, 0.5, Interpolation::Linear),
  (60.25, 1., Interpolation::Linear),
  (60.4, 0.5, Interpolation::Linear),
  (60.55, 1., Interpolation::Linear),
  (60.7, 0.5, Interpolation::Linear),
  (60.85, 1., Interpolation::Linear),
  (61., 0.5, Interpolation::Linear),
  (61.15, 1., Interpolation::Linear),
  (61.3, 0.5, Interpolation::Linear),
  (61.45, 1., Interpolation::Linear),
  (61.6, 0.5, Interpolation::Linear),
  (61.75, 1., Interpolation::Linear),
  (61.9, 0.5, Interpolation::Linear),
  (62.05, 1., Interpolation::Linear),
  (62.2, 0.5, Interpolation::Linear),
  (62.35, 1., Interpolation::Linear),
  (62.5, 0.5, Interpolation::Linear),
  (62.65, 1., Interpolation::Linear),
  (62.8, 0.5, Interpolation::Linear),
  (63.95, 1., Interpolation::Linear),
  (63.1, 0.5, Interpolation::Linear),
  (63.25, 1., Interpolation::Linear),
  (63.4, 0.5, Interpolation::Linear),
  (63.55, 1., Interpolation::Linear),
  (63.7, 0.5, Interpolation::Linear),
  (63.85, 1., Interpolation::Linear),
  ...
  (64.1, 0.5, Interpolation::Linear),
  (64.25, 1., Interpolation::Linear),
  (64.4, 0.5, Interpolation::Linear),
  (64.55, 1., Interpolation::Linear),
  (64.7, 0.5, Interpolation::Linear),
  (64.85, 1., Interpolation::Linear),
  (65., 0.5, Interpolation::Linear),
  (65.15, 1., Interpolation::Linear),
  (65.3, 0.5, Interpolation::Linear),
  (65.45, 1., Interpolation::Linear),
  (65.6, 0.5, Interpolation::Linear),
  (65.75, 1., Interpolation::Linear),
  (65.9, 0.5, Interpolation::Linear),
  (66.05, 1., Interpolation::Linear),
  (66.2, 0.5, Interpolation::Linear),
  (66.35, 1., Interpolation::Linear),
  (66.5, 0.5, Interpolation::Linear),
  (66.65, 1., Interpolation::Linear),
  (66.8, 0.5, Interpolation::Linear),
  (66.95, 1., Interpolation::Linear),
  (67.1, 0.5, Interpolation::Linear),
  (67.25, 1., Interpolation::Linear),
  (67.4, 0.5, Interpolation::Linear),
  (67.55, 1., Interpolation::Linear),
  (67.7, 0.5, Interpolation::Linear),
  (67.85, 1., Interpolation::Linear),
  (68., 1., Interpolation::Linear),
